...
# Train Pegasos with the best hyperparameters
...
print(f"Test Accuracy with stopwords removed and count features: {test_accuracy:.4f}")
...
# best_T_perceptron = 25
# best_T_avg_perceptron = 25
# best_T_pegasos = 25
# best_L_pegasos = 0.01

# test_accuracy_pegasos = p1.classifier_accuracy(p1.pegasos, train_bow_features, test_bow_features, train_labels, test_labels, T=best_T_pegasos, L=best_L_pegasos)
# print(f"Pegasos - Test Accuracy: {test_accuracy_pegasos[1]:.4f}")
...
# # Find the most explanatory words
# sorted_word_features = utils.most_explanatory_word(theta, wordlist)

# print("Most Explanatory Word Features for Positive Classification")
# for i, word in enumerate(sorted_word_features[:10]):
