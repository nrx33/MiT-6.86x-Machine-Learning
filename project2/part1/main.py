...
print('Linear Regression test_error (lambda = 0.01) =', run_linear_regression_on_MNIST(lambda_factor=0.-1))
...
print('softmax test_error (T=1) =', run_softmax_on_MNIST(temp_parameter=1))
print('softmax test_error (T=2) =', run_softmax_on_MNIST(temp_parameter=2))
